  ...
  module ConfigurationMethods
    ...
    module ClassMethods
      ...
      def default_per_page
        (defined?(@_default_per_page) && @_default_per_page) || Pagination.config.default_per_page
      end
      ...
      def max_per_page
        (defined?(@_max_per_page) && @_max_per_page) || Pagination.config.max_per_page
      end
      ...
      def max_pages(val = :none)
        if val == :none
          # getter
          (defined?(@_max_pages) && @_max_pages) || Pagination.config.max_pages
        else
          # setter
          @_max_pages = val
        end
