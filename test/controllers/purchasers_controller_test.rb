...
class PurchasersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchaser" do
    assert_difference('Purchaser.count') do
      post purchasers_url, params: { purchaser: { name: @purchaser.name, user_id: @purchaser.user_id } }
    end
  ...
  test "should update purchaser" do
    patch purchaser_url(@purchaser), params: { purchaser: { name: @purchaser.name, user_id: @purchaser.user_id } }
