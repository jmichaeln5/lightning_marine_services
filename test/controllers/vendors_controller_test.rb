...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { name: @vendor.name, purchaser_id: @vendor.purchaser_id, user_id: @vendor.user_id } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { name: @vendor.name, purchaser_id: @vendor.purchaser_id, user_id: @vendor.user_id } }
