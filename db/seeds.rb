...
# end
#
# def end_section_output(message, message_two = nil)
#   puts " "
#   puts "*"*20
#   puts "#{message}"
#   puts "*"*20
...
#
# if user_klass_nil?
#   section_output("No Users, Creating Admin User...")
#
#   admin_user = User.new( id: 1, first_name: 'Admin', last_name: "Account", phone_number: "+1(954)-706-2270", email: admin_email, username: "adminuser", password: admin_pass, password_confirmation: admin_pass)
#
#   admin_user.add_role "admin"
#   admin_user.skip_confirmation!
#   admin_user.save
#
#   end_section_output(message = admin_user.inspect, message_two = "#{admin_user.username} created.")
# end
#
#
# # **** Creating default predefined_directory_links
#
# def directory_link_klass_nil?
#   DirectoryLink.first.nil?
# end
#
# DirectoryLink.predefined_directory_links if directory_link_klass_nil? or
# DirectoryLink.predefined_directory_links.count < 4
#
...
# if Rails.env.development? # COMMENT OUT UNLESS BEFORE Prod PUSH!!!
